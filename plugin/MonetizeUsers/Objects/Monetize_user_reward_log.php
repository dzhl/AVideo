...
class Monetize_user_reward_log extends ObjectYPT {
    ...
    protected $id,$videos_id,$video_owner_users_id,$percentage_watched,$seconds_watching_video,$when_watched,$who_watched_users_id, $total_reward, $timezone, $created_php_time;
